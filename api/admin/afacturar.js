...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    if (req.method === 'PUT') {
      ...
      if (csv.length > 4 * 1024 * 1024) return res.status(413).json({ ok: false, error: 'El archivo supera 4 MB.' });
    ...
    const messages = {
      ...
      AFACTURAR_REQUIRED_COLUMNS: 'Faltan columnas requeridas: PLATAFORMA y ACCESO DIRECTO.',
      ...
      AFACTURAR_STORAGE_NOT_READY: 'Falta configurar Vercel Blob privado.'
    };
